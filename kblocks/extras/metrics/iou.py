...
class IntersectionOverUnion(tf.keras.metrics.Metric):
    ...
    def __init__(self,
        ...
        self.union = self.add_weight('union',
                                     shape=(),
...
class IndividualIntersectionOverUnion(IntersectionOverUnion):
    ...
    def __init__(self, index, **kwargs):
        self._index = index
        super(IndividualIntersectionOverUnion, self).__init__(threshold=None,
                                                              **kwargs)
    ...
    def update_state(self, y_true, y_pred, sample_weight=None):
        ...
        return super(IndividualIntersectionOverUnion,
...
class MeanIntersectionOverUnion(tf.keras.metrics.Metric):
    ...
    def __init__(self,
        ...
        self.ignore_weights = ignore_weights
        self.ious = tuple(
            IntersectionOverUnion(threshold=None,
                                  name='iou-%s' % name,
                                  dtype=dtype,
    ...
    def update_state(self, y_true, y_pred, sample_weight=None):
        ...
        for i, iou in enumerate(self.ious):
            updates.append(
                iou.update_state(tf.equal(y_true, i), tf.equal(y_pred, i),
                                 sample_weight))
