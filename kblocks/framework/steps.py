...
# @gin.configurable(module='kb.framework')
# def batches_per_epoch(batch_size: Optional[int] = None,
...
#                     examples_per_epoch: Optional[int] = None) -> int:
#     return batches_per_epoch(batch_size, examples_per_epoch) * epochs

# @gin.configurable(module='kb.framework')
# def epochs_in_batches(num_batches: int,
#                       batch_size: Optional[int] = None,
#                       examples_per_epoch: Optional[int] = None) -> int:
#     return num_batches * get_batch_size(batch_size) // get_examples_per_epoch(
#         examples_per_epoch)
