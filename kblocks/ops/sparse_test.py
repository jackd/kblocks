...
class SparseOpsTest(tf.test.TestCase):
    ...
    def test_unstack(self):
        ...
        np.testing.assert_equal(unstacked[0].indices, [
            [0, 2],
            [0, 5],
            [1, 1],
            [1, 2],
        ...
        np.testing.assert_equal(unstacked[1].indices, [
            [0, 2],
            [0, 5],
            [1, 1],
            [2, 2],
        ...
        np.testing.assert_equal(unstacked[2].indices, [
            [0, 4],
            [1, 2],
            [1, 4],
            [1, 5],
        ...
        np.testing.assert_allclose(unstacked[2].values, np_values[[4, 8, 9,
                                                                   10]])
        for u in unstacked:
